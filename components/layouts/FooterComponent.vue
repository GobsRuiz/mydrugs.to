<template>
  <footer class="footer max-w-[1300px] border-t border-customWhite-400 mx-auto py-4 px-4">
    ...
    <p class="text-center text-customWhite-100 text-xs font-bold">
        Developed by: <a class="text-customBlue-300" href="http://gobsruiz.com.br/" target="_blank">gobs.ruiz</a>
    </p>
  </footer>
</template>
